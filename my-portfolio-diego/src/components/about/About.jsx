        ...
        <div className="wrap">
          <div className="cube">
            ...
            <img
              className="landing"
              src={
                "https://assets.algoexpert.io/spas/main/prod/ge715d58bea-prod/dist/images/4f67b9c3f3ba9f0538d0.png"
              }
              alt="GitHUb"
            />
        ...
        <div className="about__content">
          ...
          <div id="board">
            ...
            <div class="rocks1">
              ...
              Temporibus eius nobis architecto dolorum earum, atque
              reprehenderit laborum aspernatur quo magni culpa facilis velit
              maiores ex deleniti? Dolores rerum dolor vitae.
            </div>
            <div id="points">
              0 
